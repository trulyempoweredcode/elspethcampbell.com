...
## State
Round 1 (portal round **327**) opened and she was invited on 29-08-2026 11:41. Client stage 4 Revisions, waiting on client. Round 1 feedback arrived 13 to 16-09-2026. Change request 203 (she wants the design format of ashleymeyer.co.uk) is with Rick, who spoke to her on 17-09-2026. Change request 204 (the homepage rebuilt as her five sections) was actioned on 17-09-2026: her portrait framed whole beside the heading (a contained split inside the hero wrapper, after the first pass with hero--half blew the photo up and cropped it), an invitation split with a generated abstract stand-in image, the list of what brings people here, her practice statement as a full-width image band with centred text and the booking button over a second generated stand-in, and a membership logo row. The service cards and homepage testimonials came off the homepage at her request. Open from that round: her chosen background images for the two bands, the Counselling Directory badge (their site blocks automated access), and a sharper APP logo.
